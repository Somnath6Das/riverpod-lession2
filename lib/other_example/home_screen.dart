...
import 'package:riverpod_lesson2/other_example/state_notifier_provider/state_notifier5.dart';
              ...
              TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const StateNotifier2()),
                  );
                },
                child: const Text(
                  'State Notifier2',
              ...
              TextButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const StateNotifier5()),
                  );
                },
                child: const Text(
                  'State Notifier5',
